...
public class ManageBook {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n==== 가격 변경 ====");
        Publication bookToChange = publications[2];
        int beforePrice = bookToChange.getPrice();
        System.out.println(bookToChange.getTitle() + " 변경 전 가격: " + beforePrice + "원");
        modifyPrice(bookToChange);
        int afterPrice = bookToChange.getPrice();
        System.out.println(bookToChange.getTitle() + " 변경 후 가격: " + afterPrice + "원");
